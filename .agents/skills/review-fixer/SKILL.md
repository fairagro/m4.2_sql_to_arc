...
packing **and** first-party `/code-review` reports (`<!-- m42-ai:code-review -->` + numbered **Path** bullets; legacy
Findings index tables still parse), not only the latest submission — Copilot “Suppressed comments” and code-review
