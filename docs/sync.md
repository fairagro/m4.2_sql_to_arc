...
| Quality scripts / hooks           | `scripts/quality-{check,fix}.sh`, `scripts/setup-git-hooks.sh`, `scripts/git-hooks/**`, `scripts/update-dockerfile-pins.sh`, `scripts/prune-merged-branches.sh`, `scripts/devcontainer-post-create.sh`, `scripts/import-public-gpg-keys.sh`                     |
| Python quality fragments          | `ruff.toml`, `mypy.ini`, `.pylintrc`, `.bandit`, `pyrightconfig.json`, `.pre-commit-config.yaml`, `scripts/run-import-linter.sh`, `scripts/run-quality-cli.sh`, `scripts/load-quality-path-env.sh`, `scripts/quality-tools-pins.txt`, `scripts/run-uv-audit.sh` |
...
| -------------------------------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`*.global` + product overlay** | Tool or docs support a synced SoT file plus a product-local file sync must not overwrite | `surface-quality-bar.global.md` + `surface-quality-bar.md`; `principles.global.md` + `principles.md` (import-linter is product-owned `.importlinter` only — not a `.global` pair; see `docs/quality.md`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
