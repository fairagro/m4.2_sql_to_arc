...
| Python quality fragments          | `ruff.toml`, `mypy.ini`, `.pylintrc`, `.bandit`, `.importlinter.global`, `pyrightconfig.json`, `.pre-commit-config.yaml`, `scripts/run-import-linter.sh`                                               |
