...
| Python quality fragments          | `ruff.toml`, `mypy.ini`, `.pylintrc`, `.bandit`, `pyrightconfig.json`, `.pre-commit-config.yaml`, `scripts/run-import-linter.sh`, `scripts/run-quality-cli.sh`, `scripts/quality-tools-pins.txt`, `scripts/run-uv-audit.sh`                 |
